...
val onPrimaryLight = Color(0xFFFFF176)
...
val FireTypeColor = Color(0xFFEF5350)       // Ярко-красный (огонь)
val WaterTypeColor = Color(0xFF42A5F5)      // Синий (вода)
val PoisonTypeColor = Color(0xFF9C27B0)     // Фиолетовый (яд)
val GrassTypeColor = Color(0xFF66BB6A)      // Зелёный (трава)
val FlyingTypeColor = Color(0xFF90CAF9)     // Светло-голубой (воздух/небо)
val BugTypeColor = Color(0xFF9CCC65)        // Жёлто-зелёный (насекомые)
val NormalTypeColor = Color(0xFFB0BEC5)     // Серый (обычный)
val ElectricTypeColor = Color(0xFFFFEB3B)   // Жёлтый (электричество)
val FightingTypeColor = Color(0xFFE57373)   // Розовато-красный (бой)
val SteelTypeColor = Color(0xFFB0BEC5)      // Металлический серый (сталь)
val IceTypeColor = Color(0xFF81D4FA)        // Голубой (лёд)
val GhostTypeColor = Color(0xFF7E57C2)      // Тёмно-фиолетовый (призрак)
val RockTypeColor = Color(0xFF8D6E63)       // Коричневый (камень)
val PsychicTypeColor = Color(0xFFF06292)    // Розовый (психика)
val DarkTypeColor = Color(0xFF4A4A4A)       // Тёмно-серый (тёмный)
val DragonTypeColor = Color(0xFF512DA8)     // Фиолетово-синий (дракон)
val FairyTypeColor = Color(0xFFF8BBD0)      // Светло-розовый (фея)
val GroundTypeColor = Color(0xFFD7CCC8)     // Светло-коричневый (земля)
val UnknownTypeColor = Color(0xFF757575)    // Тёмно-серый (по умолчанию)
